 ...
 *  12195677
 *
 * horizontalbarchart.js contains the functions and variables that create the bar chart
 **/
...
function makeBarchart() {
   ...
   //Sort data in descending order and take the 5 group of terrorist with most attacks
