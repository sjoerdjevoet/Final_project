...
var CountryDict
var AanslagenValue
while (i < dictaanslagen_for_map.length){

CountryDict = dictaanslagen_for_map[i].Country;
AanslagenValue = dictaanslagen_for_map[i].Aanslagen;

while ( j < data.features.length ){

CountryJson = data.features[j].properties.admin
i++
if( CountryDict == CountryJson){
  data.features[j].properties.aanslagen = AanslagenValue
  console.log(AanslagenValue);
  j++;
  break;
}
